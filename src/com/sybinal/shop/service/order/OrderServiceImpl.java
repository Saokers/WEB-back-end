...
public class OrderServiceImpl implements OrderService {
	...
	@Override
	public int getOrderSum(String orderNum) {
		return orderItemMapper.getOrderSum(orderNum);
	}
	 ...
	 */
	@Override
	public int internetValue(OrderZfb orderzfb) {
		orderzfb.setType(0);
		return orderMapper.internetValue(orderzfb);
	}
