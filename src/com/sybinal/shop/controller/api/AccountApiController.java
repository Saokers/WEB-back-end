...
public class AccountApiController extends AbstractApiController {
	...
	public ApiResponseObject rechargeAccount(@RequestBody Account account) {
		...
		ApiResponseObject apiResponseObject = reponseJSON(ApiResponseEnum.FAIL.getCode(),
				ApiResponseEnum.FAIL.getName(), false);
		if (u != null) {
	...
	@RequestMapping(value = "/account/record", method = RequestMethod.POST, headers = "Accept=application/json")
